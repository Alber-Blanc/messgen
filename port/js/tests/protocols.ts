import type {
  MessgenTestComplexStruct,
  MessgenTestSimpleStruct,
  MessgenTestEmptyStruct,
  MessgenTestComplexStructNostl,
  MessgenTestStructWithEnum,
  CrossProto,
  MessgenTestVarSizeStruct,
  MessgenTestComplexStructWithEmpty,
  MessgenTestFlatStruct,
} from './types';
