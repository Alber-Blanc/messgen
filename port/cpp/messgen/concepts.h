...
concept message = type<typename std::remove_cvref_t<Message>::data_type> &&
                  requires(std::remove_cvref_t<Message> msg, std::remove_cvref_t<Message>::recv msg_recv, std::remove_cvref_t<Message>::send msg_send, typename std::remove_cvref_t<Message>::data_type_stor &data, uint8_t *buf) {
