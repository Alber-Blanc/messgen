...
TEST_F(CppTest20, StructWithEnum) {
...
TEST_F(CppTest20, VarSizeStruct) {
...
TEST_F(CppTest20, ComplexStruct) {
...
TEST_F(CppTest20, FlatStructZeroCopy) {
    messgen::test::flat_struct msg{};
...
TEST_F(CppTest20, ComplexStructWithEmpty) {
