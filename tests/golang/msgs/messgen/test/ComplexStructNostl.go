...
type ComplexStructNostl struct {
...
func (s *ComplexStructNostl) SerializedSize() uint32 {
	result := 0
...
func (s *ComplexStructNostl) Serialize(output []byte) (uint32, error) {
	selfBytes := (*[520]byte)(unsafe.Pointer(s))
...
func (s *ComplexStructNostl) Deserialize(input []byte) (uint32, error) {
	selfBytes := (*[520]byte)(unsafe.Pointer(s))
